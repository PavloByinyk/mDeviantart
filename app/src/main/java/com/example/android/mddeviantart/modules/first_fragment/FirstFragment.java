...
public class FirstFragment extends BaseFragment implements IFirstFragmentContract.IView, MainImageAdapter.MainImageClickListener, SwipeRefreshLayout.OnRefreshListener {

    private IFirstFragmentContract.IPresenter mPresenter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        setPresenter(new FirstFragmentPresenter(this));
        mPresenter.onStart();
    }
    ...
    @Override
    public void setPresenter(IFirstFragmentContract.IPresenter presenter) {
